...
public class ClioPersistenceConnection implements Closeable {
    ...
    private void connect() throws PersistenceException {
        synchronized (this) {
            ...
            //The following parameter can be modified accordingly to generate the tables if needed
     ...
     *
     * @throws PersistenceException In case there as a persistence problem.
     */
    public void verifyConnection() throws PersistenceException {
        getSessionFactory();
    }
