package eu.europeana.clio.link.checking.service.config;
...
/**
 * Class containing configuration for the {@link LinkCheckingEngine}
 */
public class LinkCheckingEngineConfiguration {
  ...
  public SolrProperties<ConfigurationException> getSolrProperties() throws ConfigurationException {
    ...
    properties.setZookeeperHosts(
        publishSolrZookeeperConfigurationProperties.getZookeeper().getHosts(),
        publishSolrZookeeperConfigurationProperties.getZookeeper().getPorts());
