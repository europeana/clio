...
public class BatchesRequestResult {
    ...
    @Schema(title =
            "How many datasets were excluded because they were still pending from a previous batch. If absent, this number is not known.", type = "integer")
    ...
    @Schema(title =
            "How many datasets were excluded because they did not have records with links to check. If absent, this number is not known.", type = "integer")
